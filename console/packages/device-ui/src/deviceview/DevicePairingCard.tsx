 ...
 * the user to approve on the device (`jcode cloud approve <id>`), denied /
      ...
      <div className={styles.body}>
        ...
        <p className={styles.text}>
          {pairing.phase === 'pending' && pairing.pairingId
            ? t('device.pairing.pending.body', { id: pairing.pairingId })
            : t(`device.pairing.${pairing.phase}.body`)}
        </p>
        {pairing.phase === 'pending' && pairing.pairingId && (
          <code className={styles.command}>jcode cloud approve {pairing.pairingId}</code>
        )}
